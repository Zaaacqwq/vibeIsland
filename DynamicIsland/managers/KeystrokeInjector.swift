/*
 * VibeIsland — vendored from Open Vibe Island (Open Island), GPL v3.
 * Copyright (C) 2026 Zaaacqwq; original Copyright (C) Octane0411 and
 * Open Island contributors. See NOTICE. Licensed under GPL v3.
 */
