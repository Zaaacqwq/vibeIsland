...
class BluetoothAudioManager: ObservableObject {
    ...
    /// when AirPods device properties change. Payload keys vary by macOS version,
    /// so handlers parse first and then fall back to an event-triggered IORegistry read.
