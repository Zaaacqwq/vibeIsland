...
enum MediaControllerType: String, CaseIterable, Identifiable, Defaults.Serializable {
    ...
    var localizedName: String {
        ...
        case .neteaseMusic: return String(localized: "NetEase Cloud Music")
...
extension Defaults.Keys {
    ...
    static let releaseName = Key<String>("releaseName", default: "Sunrise")
    ...
    static let calendarContentMode = Key<CalendarContentMode>("calendarContentMode", default: .events)
    static let didMigrateReminderListSelection = Key<Bool>("didMigrateReminderListSelection", default: false)
    static let hideCompletedReminders = Key<Bool>("hideCompletedReminders", default: true)
    static let hideAllDayEvents = Key<Bool>("hideAllDayEvents", default: false)
    static let calendarTabLayout = Key<CalendarTabLayout>("calendarTabLayout", default: .scrollingMonth)
